...
+ (PopoverView *)showPopoverAtPoint:(CGPoint)point inView:(UIView *)view withContentView:(UIView *)cView isFitView:(BOOL)isFitView delegate:(id<PopoverViewDelegate>)delegate {
    PopoverView *popoverView = [[PopoverView alloc] initWithFrame:CGRectZero];
    popoverView.isFitView = isFitView;
...
//    CGSize titleSize = [title sizeWithFont:kTitleFont];
    CGSize titleSize = [title boundingRectWithSize:CGSizeZero
                                         options:NSStringDrawingUsesLineFragmentOrigin
...
//        CGSize textSize = [string sizeWithFont:font];
        CGSize textSize = [string boundingRectWithSize:CGSizeZero
                                               options:NSStringDrawingUsesLineFragmentOrigin
                                            attributes:@{NSFontAttributeName:kTitleFont}
                                               context:nil].size;
...
- (void)showAtPoint:(CGPoint)point inView:(UIView *)view withContentView:(UIView *)cView {
    ...
    topView = [PopoverView topMostController].view;
